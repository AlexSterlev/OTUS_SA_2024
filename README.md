...
<details>
	<summary>
		<h4>US001 Я как контент-менеджер хочу авторизоваться в системе что бы управлять и отслеживать проигрываемый контент.</h4>
	</summary>
...
- Пользователь должен иметь возможность запросить восстановление доступа к своему аккаунту в случае утери или забытого пароля, с помощью механизма восстановления пароля по электронной почте.</details>
