...
<tr><td valign="top">10</td><td valign="top"><i>Система должна обеспечивать работу не мение 50 пользователей единовременно</i></td><td valign="top"><i>Нефункциональное</i></td></tr>
