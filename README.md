...
<a name="dev"><h3>Задачи для разработки</h3></a>
...
3 Проверка уникальности данных пользователя:
...
5.Уведомление пользователя о результате регистрации:
...
Задача для разработки: Создание функционала загрузки данных после выбора доступных устройств на сайте
Описание задачи: Необходимо реализовать функционал, который будет обеспечивать загрузку данных о выбранных устройствах после того, как пользователь отметил их с помощью чекбоксов на сайте сервиса.
Действия:
...
2.	Обработка выбранных устройств:
...
5.	Подготовка данных для загрузки:
