...
<spoiler title="US003 Я как контент менеджер хочу иметь возможность централизованно загружать плейлисты и видео в терминалы, для того что бы тратить меньше времени.">
