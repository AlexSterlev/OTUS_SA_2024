...
- Ожидаемое снижение расходов на транспортные расходы на 40% и сокращение штата обслуживающего персонала как минимум на треть.
...
<a name="treb"><h3>Определение требований</h3></a>
